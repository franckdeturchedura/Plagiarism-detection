...
/* Retourner la cha�ne de caract�re c                              */
/* =============================================================== */
{
	char tmp;
	int m, j, i;
...
void affiche(char* texte1, char* texte2, int nbcar)
  /* Affiche simultan�ment texte1 et texte 2 en positionnnant nbcar  
     caract�res sur chaque ligne. */
/* =============================================================== */
{
	int i, l1, l2, l;
...
void affiche2(char* texte1, char* texte2, int nbcar)
  /* idem affiche, mais avec un formattage diff�rent
/* =============================================================== */
{
...
/* Renvoie le coup d'une substitution des caract�res x et y. */
/* =============================================================== */
{
	if( x == y ) return 0;
	else return 1;
